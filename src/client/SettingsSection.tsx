...
export function AtFileSection({
  ...
  return (
    <section className="dsh_atFile_section" aria-labelledby="dsh-at-any-settings-title">
      <h2 id="dsh-at-any-settings-title" className="dsh_atFile_title">{t('settings.title')}</h2>
