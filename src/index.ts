/**
 * dsh-at-any host plugin: mounts the `atFile` Typert Remote service
...
export const Config = z.object({
  ...
  // cases only.
  maxIndexedFiles: z.natural().min(1).default(DEFAULT_MAX_INDEXED_FILES),
