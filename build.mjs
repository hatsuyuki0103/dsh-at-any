/**
 * Single-file client + ESM host build for dsh-at-any.
 *
 * The web server serves exactly one file per plugin (/plugins/dsh-at-any/client.js),
...
await build({
  ...
  banner: {
    js: "window.__ModuleLoader__.load({ id: 'dsh-at-any', factory: (require) => { var module = { exports: {} }; var exports = module.exports;",
  },
  footer: {
